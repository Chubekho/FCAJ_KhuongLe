...
| --- | --- | --- | --- | --- |
| 2 | - Tìm hiểu Amazon S3: object storage, storage class, versioning. <br> - **Thực hành:** Tạo bucket, bật Static Website Hosting, cấu hình Bucket Policy public-read, deploy một trang HTML tĩnh và truy cập qua endpoint S3. | 18/05/2026 | 18/05/2026 | [Tài liệu FCAJ](https://cloudjourney.awsstudygroup.com/vi/1-explore/) |
| 3 | - Tìm hiểu Amazon RDS: managed relational database, so sánh với tự vận hành DB trên EC2 (backup, patching, Multi-AZ). <br> - **Thực hành:** Khởi tạo RDS PostgreSQL instance trong Private Subnet, cấu hình Security Group để chỉ EC2 trong VPC truy cập được. | 19/05/2026 | 19/05/2026 | [Tài liệu FCAJ](https://cloudjourney.awsstudygroup.com/vi/1-explore/) |
| 4 | - Tìm hiểu Amazon CloudWatch: Metrics, Logs, Alarms, Dashboard. <br> - **Thực hành:** Tạo CloudWatch Alarm theo dõi CPUUtilization của EC2, kết nối SNS Topic để nhận cảnh báo qua email khi vượt ngưỡng. | 20/05/2026 | 20/05/2026 | [Tài liệu FCAJ](https://cloudjourney.awsstudygroup.com/vi/1-explore/) |
| 5 | - Tìm hiểu EC2 Auto Scaling: Launch Template, Auto Scaling Group (ASG), Target Tracking Policy. <br> - **Thực hành:** Tạo Launch Template từ AMI có sẵn, tạo ASG scale theo % CPU trung bình, kiểm tra hành vi scale-out/scale-in. | 21/05/2026 | 21/05/2026 | [Tài liệu FCAJ](https://cloudjourney.awsstudygroup.com/vi/1-explore/) |
| 6 | - Thực hành lab **"Đảm bảo truy cập Hybrid an toàn đến S3 bằng VPC Endpoint"**: dựng 2 VPC (Cloud & On-Prem), tạo Gateway Endpoint và Interface Endpoint tới S3, mô phỏng kết nối Site-to-Site VPN, kiểm tra resolve DNS từ phía on-prem. | 22/05/2026 | 22/05/2026 | [Tài liệu FCAJ](https://cloudjourney.awsstudygroup.com/vi/1-explore/) |
